...
def main_red_black():
    ...
    while True:
        user_input = input("Enter a number to delete (or type 'done' to finish): ")
        ...
        try:
            ...
            steps.append(generate_latex_red_black_tree(rb_tree.root, rb_tree, is_root=True))
            print(f"Node {value} deleted from the Red-Black tree.")
