...
def main():
    ...
    root.left.left.left= BinaryTreeNode(70)
    ...
    filename = "binary_tree_dfs_steps.tex"

    with open(filename, "w") as file:
        file.write(latex_document)

    print(f"LaTeX code for binary tree traversal steps has been generated and saved to {filename}")
